...
#define BFInstance [EVSRouter sharedInstance]
...
@implementation EVSRouter

+ (instancetype _Nonnull )sharedInstance
{
    static EVSRouter *instance = nil;
